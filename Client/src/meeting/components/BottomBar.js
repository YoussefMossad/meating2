...
export function BottomBar({
  ...
  // Add useState for dialog state
  const [showLeaveConfirmation, setShowLeaveConfirmation] = useState(false);

  // Updated LeaveBTN component
  const LeaveBTN = () => {
    const { leave } = useMeeting();
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="mt-2 w-24 inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="mt-2 ml-3 w-24 inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm"
                  >
                    Leave
                  </button>
                </div>
